    ...
    <section className="pt-24 pb-20 px-4 sm:px-6 max-w-[700px] mx-auto">
      ...
      <div className="text-center">
        <p className="text-xs" style={{ color: "var(--text-faint)" }}>
          This stack was generated by <Link href="/" className="no-underline" style={{ color: "var(--accent-text)" }}>Assure Fintech</Link> — India's smartest credit card tool. Free, with no account required.
        </p>
      </div>
    </section>
    </>
