...
const SvgCapBinding = () => (
  <svg viewBox="0 0 720 289" role="img" aria-label="How a 5 percent cashback rate becomes 1.5 percent when monthly cap of 500 rupees binds at 33000 rupees monthly spend" style={{ width: "100%", maxWidth: 760, margin: "20px 0" }}>
    ...
    <text x="383" y="65" fontFamily="system-ui" fontSize="10" fill="#dc2626">(₹500 cap ÷ 5% = ₹10K max)</text>
        <text x="20" y="255" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Axis Ace: 5% on Swiggy/Zomato/Ola/Uber. Cap: ₹500/month per category. At ₹33K spend, effective rate = 1.5%. The billboard</text>
    <text x="20" y="269" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">says 5%.</text>
  </svg>
);

const SvgBankCapTable = () => (
  <svg viewBox="0 0 720 257" role="img" aria-label="Monthly cashback cap comparison for top 5 cashback credit cards in India showing Axis Ace HDFC Millennia SBI Cashback Amazon Pay ICICI and Flipkart Axis with their advertised rates and effective rates at different spend levels" style={{ width: "100%", maxWidth: 760, margin: "20px 0" }}>
    ...
    {[
      ...
      <g key={row[0]}>
        ...
        <text x="20" y="215" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">*SBI Cashback has the highest cap (₹5,000/month) making it genuinely the best cashback card at high spend levels. Amazon</text>
    <text x="20" y="229" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Pay ICICI has no cap on Amazon — the only truly uncapped card for a specific ecosystem.</text>
  </svg>
);

const SvgGSTOnCashback = () => (
  <svg viewBox="0 0 720 202" role="img" aria-label="GST on credit card annual fee affecting net cashback earned showing that at high annual fees the GST adds to effective cost reducing net return" style={{ width: "100%", maxWidth: 760, margin: "20px 0" }}>
    ...
    <text x="30" y="148" fontFamily="system-ui" fontSize="12" fill="var(--text)">True effective cashback rate after fee: ₹3,620 / ₹2,40,000 = 1.51%. Every fee card does this.</text>
        <text x="20" y="168" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Always calculate: (annual cashback earned - annual fee - GST on fee) / total annual spend = TRUE cashback rate. Not the</text>
    <text x="20" y="182" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">headline.</text>
  </svg>
);

const SvgPartnerSpendOnly = () => (
  <svg viewBox="0 0 720 251" role="img" aria-label="Credit card cashback only on partner merchants showing that most of your spending may not qualify for the advertised high cashback rate" style={{ width: "100%", maxWidth: 760, margin: "20px 0" }}>
    ...
    {[
      ...
      <g key={cat}>
        ...
        <text x="20" y="192" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Total ₹45,000 spend → ₹880 earned → effective rate: 1.96%. The card advertises "5% on partner merchants." Your real</text>
    <text x="20" y="206" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">portfolio earns under 2%.</text>
  </svg>
);

const SvgTrueRateComparison = () => (
  <svg viewBox="0 0 720 256" role="img" aria-label="True effective cashback rate comparison across 5 popular credit cards after accounting for caps fees partner-only restrictions and GST" style={{ width: "100%", maxWidth: 760, margin: "20px 0" }}>
    ...
    {[
      ...
      <g key={card}>
        ...
        <text x="20" y="193" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Amazon Pay ICICI and SBI Cashback hold up best in real-world mixed spend. Axis Ace and Flipkart Axis lose their headline</text>
    <text x="20" y="207" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">rate fast when you buy outside their partner ecosystem.</text>
  </svg>
);

const SvgHowToFind = () => (
  <svg viewBox="0 0 720 242" role="img" aria-label="Step by step guide to finding the true cashback rate for any credit card by reading the MITC document" style={{ width: "100%", maxWidth: 760, margin: "20px 0" }}>
