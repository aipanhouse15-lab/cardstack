...
export default function BlogBnplVsCreditCardsIndia() {
  ...
  return (
    <main style={{ maxWidth: 800, margin: "0 auto", padding: "44px 22px 88px", fontFamily: "system-ui, -apple-system, sans-serif", color: "var(--text)", lineHeight: 1.65 }}>
      ...
      <h1 style={{ fontSize: 32, lineHeight: 1.2, fontWeight: 800, margin: "0 0 14px" }}>BNPL vs Credit Cards in India: Read This Before You Sign Up</h1>
      <p style={{ fontSize: 17, color: "var(--text-muted)", margin: "0 0 16px" }}>Buy Now Pay Later sounds like a smarter credit card. In most cases, it's a more expensive one that doesn't even build your CIBIL score. Here's the honest comparison.</p>
