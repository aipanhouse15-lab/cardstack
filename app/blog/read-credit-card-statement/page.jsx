...
export default function BlogReadCreditCardStatement() {
  ...
  return (
    <main style={{ maxWidth: 800, margin: "0 auto", padding: "32px 22px 48px", fontFamily: "system-ui, -apple-system, sans-serif", color: "var(--text)", lineHeight: 1.65 }}>
      ...
      <h1 style={{ fontSize: 32, lineHeight: 1.2, fontWeight: 800, margin: "0 0 14px" }}>How to Read Your Credit Card Statement: A Plain-English Walkthrough</h1>
      <p style={{ fontSize: 17, color: "var(--text-muted)", margin: "0 0 16px" }}>Your monthly statement is full of traps disguised as numbers. Here's how to decode every line before it costs you money.</p>
