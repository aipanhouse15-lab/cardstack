...
const SvgHighSpendCards = () => (
  <svg viewBox="0 0 720 336" role="img" aria-label="Best credit cards for high spenders in India 2026 showing monthly value generated by HDFC Infinia Axis Magnus Amex Platinum and SBI Cashback at 1 lakh monthly spend" style={{ width: "100%", maxWidth: 760, margin: "20px 0" }}>
    ...
    {[
      ...
      <g key={card}>
        ...
        <text x="20" y="255" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Value = cashback + estimated reward point value + benefits (lounge, travel credit, milestone bonuses). SBI Cashback wins</text>
    <text x="20" y="269" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">on pure cashback rate at ₹1L/month — no complex redemption needed.</text>
  </svg>
);

const SvgInfiniaVsMagnus = () => (
  <svg viewBox="0 0 720 249" role="img" aria-label="Head to head comparison of HDFC Infinia and Axis Magnus credit cards for high spenders showing reward rates lounge access benefits and annual fees" style={{ width: "100%", maxWidth: 760, margin: "20px 0" }}>
    ...
    {[
      ...
      <g key={row[0]}>
        ...
        <text x="20" y="215" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Infinia is the better card if you can get it (invite required). Magnus is easier to get and almost as good for</text>
    <text x="20" y="229" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">travel-heavy spenders. If your spend is online-heavy: SBI Cashback beats both on pure cashback math.</text>
  </svg>
);

const SvgSpendProfile = () => (
  <svg viewBox="0 0 720 276" role="img" aria-label="High spender credit card recommendation by spend profile showing which card wins for different spending patterns like travel dining online shopping and fuel" style={{ width: "100%", maxWidth: 760, margin: "20px 0" }}>
    ...
    {[
      ...
      <g key={profile}>
        ...
        <text x="20" y="174" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">No single card wins all categories. Stack 2 cards: one premium rewards/travel card + SBI Cashback for all online spend</text>
    <text x="20" y="188" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">not covered by partner bonuses.</text>
  </svg>
);

const SvgMilestoneCalculator = () => (
  <svg viewBox="0 0 720 204" role="img" aria-label="Annual milestone benefit calculation showing how HDFC Infinia and Axis Magnus milestone bonuses add significant value at 10 lakh annual spend" style={{ width: "100%", maxWidth: 760, margin: "20px 0" }}>
    ...
    <text x="540" y="135" textAnchor="middle" fontFamily="system-ui" fontSize="15" fontWeight="800" fill="#16a34a">Net: ~₹25,250 value</text>
        <text x="20" y="170" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Infinia fee is waived at ₹10L annual spend. Magnus fee is not fully waived but some milestone credits offset it.</text>
    <text x="20" y="184" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Net-of-fee comparison clearly favours Infinia at ₹10L spend.</text>
  </svg>
);

const SvgLoungeComparison = () => (
  <svg viewBox="0 0 720 238" role="img" aria-label="Airport lounge access comparison for premium credit cards showing which cards offer unlimited free lounge visits domestically and internationally" style={{ width: "100%", maxWidth: 760, margin: "20px 0" }}>
    ...
    {[
      ...
      <g key={card}>
        ...
        <text x="20" y="152" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Unlimited Priority Pass (Infinia) is the gold standard. At ₹1,500-3,000 per lounge visit, a frequent traveller using 20</text>
    <text x="20" y="166" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">lounges/year saves ₹30,000-60,000 annually — significantly offsetting the annual fee.</text>
  </svg>
);
