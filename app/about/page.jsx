...
export const metadata = {
  title: "About CardStack — India's Honest Credit Card Tool",
  description: "CardStack helps Indians maximize credit card rewards with real cashback math after caps. Built lean, built honest, built for India.",
};
  ...
  return (
    <section className="pt-24 pb-20 px-6 max-w-[700px] mx-auto">
      ...
      <div className="flex flex-col gap-6 text-base leading-relaxed" style={{ color: "var(--text-secondary)" }}>
        <p>
          CardStack started from a simple frustration: Indian credit card comparison sites show "5% rewards" when the real effective cashback is 1.33%. They ignore reward caps, mix up point values, and rank cards by who pays them the most — not by what's best for you.
        </p>
        <p>
          We decided to fix that. CardStack is a free tool that calculates <strong style={{ color: "var(--text)" }}>effective cashback after reward caps</strong> — the number banks don't advertise and other sites don't calculate. When you use our Smart Swipe Guide, the savings number you see is real. Not inflated. Not theoretical.
        </p>
        ...
        <p>
          CardStack is built by one person in India. No VC funding. No team of 50. Just one person who got tired of misleading credit card comparison sites and decided to build something honest.
        </p>
        <p>
