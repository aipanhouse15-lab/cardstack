...
const GUIDES = [
  { title: "Home loan true cost: what banks hide from you", desc: "Processing fees, mandatory insurance bundling, prepayment penalties, and documentation charges — calculated into your real effective APR.", time: "6 min", tag: "Guide" },
  { title: "Personal loan: advertised 10.5%, actual 13.1%", desc: "Origination fees, late payment charges, and foreclosure penalties turn a 'cheap' personal loan expensive.", time: "5 min", tag: "Guide" },
  ...
  { title: "SBI vs HDFC vs ICICI home loan — honest comparison 2026", desc: "Not just rates. Processing fees, insurance costs, prepayment terms, and effective APR compared side by side.", time: "8 min", tag: "Compare" },
  { title: "Prepayment penalty trap: why 'no lock-in' doesn't mean free", desc: "Banks advertise zero prepayment penalty but charge 2-4% if you switch lenders. Here's how to spot the trap.", time: "5 min", tag: "Guide" },
