...
const SvgSection80E = () => (
  <svg viewBox="0 0 720 282" role="img" aria-label="Section 80E tax benefit calculation showing how education loan interest deduction saves tax across 8 years for someone earning 12 lakh per year in 30 percent bracket" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    <text x="20" y="44" fontFamily="system-ui" fontSize="12" fontWeight="700" fill="var(--text)">Year-by-year interest + tax saving (30% slab, new regime does NOT allow 80E — old regime only)</text>
    {[
    ...
    <text x="20" y="258" fontFamily="system-ui" fontSize="10" fontWeight="700" fill="#16a34a">Total tax saved over 8 years: ~₹3,79,500. On 11% loan of ₹20L, effective after-tax interest rate = ~7.7%.</text>
  </svg>
);
...
const SvgInterestVsMoratorium = () => (
  <svg viewBox="0 0 720 242" role="img" aria-label="Comparison between taking full moratorium versus paying simple interest during study period on education loan showing total savings of 4 to 6 lakh by paying during study" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
