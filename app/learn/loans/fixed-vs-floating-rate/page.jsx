...
const SvgRateHistory = () => (
  <svg viewBox="0 0 720 309" role="img" aria-label="RBI repo rate and home loan EBLR movement from 2020 to June 2026 showing the full rate cycle from 4 percent to 6.5 percent and back" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    <g>
      ...
      <text x="558" y="56" fontFamily="system-ui" fontSize="10" fill="var(--text-muted)">EBLR (home loan rate)</text>
        ...
        <text x="20" y="275" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">2022-23 rate hike cycle: EBLR jumped from 6.65% to 9.15% — floating rate borrowers paid ~₹8,000 more EMI per ₹50L.</text>
    <text x="20" y="289" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">2024-26 easing: rates fell, they benefited.</text>
  </svg>
);

const SvgEmiScenarios = () => (
  <svg viewBox="0 0 720 417" role="img" aria-label="Monthly EMI comparison for 50 lakh home loan under three rate scenarios showing fixed at 9 percent versus floating ranging from 8 to 10 percent" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[
      ...
      <g key={label}>
        ...
        <text x="20" y="275" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Gap between best and worst float: ₹6,429/month = ₹15.4L extra interest over 20 years. Fixed rate eliminates this</text>
    <text x="20" y="289" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">uncertainty but charges a premium upfront.</text>
  </svg>
);

const SvgBreakEvenAnalysis = () => (
  <svg viewBox="0 0 720 289" role="img" aria-label="Break-even analysis showing at what interest rate movement the fixed rate home loan becomes cheaper than floating over the full loan tenure" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    <text x="650" y="80" fontFamily="system-ui" fontSize="10" fill="#dc2626">Floating cost</text>
        <text x="20" y="255" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">If you believe rates will rise more than 1.2% on average over 20 years: fixed wins. If rates stay flat or fall: floating</text>
    <text x="20" y="269" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">wins.</text>
  </svg>
);

const SvgTotalInterestComparison = () => (
  <svg viewBox="0 0 720 370" role="img" aria-label="Total interest paid comparison over 20 years at various rate paths for fixed rate at 9 percent versus floating starting at 8.75 percent" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[
      ...
      <g key={scenario}>
        ...
        <text x="20" y="290" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">If rates fall steadily, floating saves ₹9.87L vs fixed. If rates spike sharply, floating costs ₹10.43L more. The question</text>
    <text x="20" y="304" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">is: which scenario do you believe in?</text>
  </svg>
);

const SvgDecisionTree = () => (
  <svg viewBox="0 0 720 349" role="img" aria-label="Decision tree for choosing between fixed and floating home loan rate based on loan tenure income stability and rate expectations" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    <text x="620" y="246" textAnchor="middle" fontFamily="system-ui" fontSize="10" fill="#bbf7d0">Statistically cheaper over 20yr</text>
        <text x="20" y="315" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">No decision tree replaces personal financial planning. If EMI rising 20% would hurt your family's monthly budget, fixed</text>
    <text x="20" y="329" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">is worth the premium.</text>
  </svg>
);

const SvgBankProductTable = () => (
  <svg viewBox="0 0 720 333" role="img" aria-label="Fixed and floating home loan rates across SBI HDFC ICICI and Axis Bank as of June 2026 showing rate premium for fixed versus floating" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[["SBI", "8.50%", "N/A", "Fixed NA", "N/A", "Only floating; no true fixed product"],
      ...
      <g key={row[0]}>
        ...
        <text x="20" y="230" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">SBI does not offer a true long-term fixed rate product as of June 2026. Axis Bank's fixed rate has the narrowest premium</text>
    <text x="20" y="244" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">if certainty is your priority.</text>
  </svg>
);
