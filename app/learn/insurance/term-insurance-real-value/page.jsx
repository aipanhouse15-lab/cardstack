...
const SvgInflationErosion = () => (
  <svg viewBox="0 0 720 286" role="img" aria-label="Value of 1 crore rupees in future years after 6 percent inflation showing it becomes equivalent to only 17 lakh rupees in todays money after 30 years" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[{ yr: "Today", val: 100, x: 60 }, { yr: "5 yrs", val: 74.7, x: 190 }, { yr: "10 yrs", val: 55.8, x: 320 }, { yr: "15 yrs", val: 41.7, x: 450 }, { yr: "20 yrs", val: 31.2, x: 580 }, { yr: "30 yrs", val: 17.4, x: 700 }].map(({ yr, val, x }, i) => (
      <g key={yr}>
        ...
        <text x="20" y="252" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">₹1 Crore feels like a lot today. At 6% inflation, its purchasing power is ₹17.4L in 30 years. A 30-year-old buying ₹1Cr</text>
    <text x="20" y="266" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">cover today is leaving their family with ₹17L equivalent at age 60. Not enough.</text>
  </svg>
);
...
const SvgPremiumComparison = () => (
  <svg viewBox="0 0 720 351" role="img" aria-label="Annual premium comparison for 1 crore term insurance for 30 year old non-smoker male across LIC HDFC Life ICICI Pru Max Life and Tata AIA" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[
      ...
      <g key={insurer}>
        ...
        <text x="20" y="255" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Online plans are 30-40% cheaper than offline. Always buy online directly from insurer website, not through agent, to save</text>
    <text x="20" y="269" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">on commission loading. LIC premium via offline agent can be ₹18,000+.</text>
  </svg>
);

const SvgRiderMatrix = () => (
  <svg viewBox="0 0 720 352" role="img" aria-label="Term insurance rider value matrix showing which riders are worth buying including waiver of premium and critical illness but not accidental death benefit" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[
      ...
      <g key={rider}>
        ...
        <text x="20" y="213" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Keep riders simple. Waiver of premium is universally worth it. For everything else, a separate standalone policy usually</text>
    <text x="20" y="227" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">gives better value than a bundled rider.</text>
  </svg>
);
...
const SvgLifeStageCoverage = () => (
  <svg viewBox="0 0 720 308" role="img" aria-label="Life stage coverage needs guide showing how much term insurance you need at different ages from 25 to 55 based on income dependents and loans" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[
      ...
      <g key={age}>
        ...
        <text x="20" y="195" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Income here = in-hand annual salary. If self-employed, use 5× net profit as proxy. Include spouse's income in family need</text>
    <text x="20" y="209" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">calculation.</text>
  </svg>
);
