...
const SvgLifeCSR = () => (
  <svg viewBox="0 0 720 304" role="img" aria-label="Life insurance claim settlement ratios for top 10 insurers in India for 2025-26 showing HDFC Life at 99.5 percent and LIC at 98.7 percent" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[
      ...
      <g key={name}>
        ...
        <text x="20" y="270" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">CSR = claims settled / (claims settled + claims repudiated + claims pending). Higher is better. But CSR above 96% is</text>
    <text x="20" y="284" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">broadly safe — focus on complaint ratio next.</text>
  </svg>
);

const SvgHealthICR = () => (
  <svg viewBox="0 0 720 307" role="img" aria-label="Health insurance incurred claims ratio for top 5 health insurers in India showing Star Health at 65 percent and New India at 110 percent" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    <text x="425" y="55" fontFamily="system-ui" fontSize="10" fill="#dc2626">100% = pays out = premiums collected</text>
        <text x="20" y="228" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">ICR above 100% means the insurer is paying more in claims than it collects in premiums — financially unsustainable.</text>
    <text x="20" y="242" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Expect premium hikes or coverage restrictions from high-ICR insurers.</text>
  </svg>
);

const SvgRejectionReasons = () => (
  <svg viewBox="0 0 720 265" role="img" aria-label="Reasons for health and life insurance claim rejection in India showing non-disclosure at 44 percent as the top reason followed by policy lapse and exclusion" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[
      ...
      <g key={reason}>
        ...
        <text x="20" y="230" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Non-disclosure is #1. When buying, always declare everything — pre-existing conditions, smoking, family history. A</text>
    <text x="20" y="244" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">rejected claim is worse than a higher premium.</text>
  </svg>
);

const SvgComplaintRatio = () => (
  <svg viewBox="0 0 720 249" role="img" aria-label="Insurance complaint ratio comparison showing complaints per 10000 policies for top life insurers revealing that high CSR and high complaints can coexist" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[
      ...
      <g key={name}>
        ...
        <text x="20" y="215" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Tata AIA: high CSR AND low complaints = best overall insurer for term. SBI Life: lower CSR and high complaints = avoid</text>
    <text x="20" y="229" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">for term.</text>
  </svg>
);

const SvgClaimProcess = () => (
  <svg viewBox="0 0 720 204" role="img" aria-label="Step by step life insurance claim process flowchart from death notification to final settlement with timeline at each step" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[
      ...
      <g key={step}>
        ...
        <text x="20" y="170" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">IRDAI regulation: if insurer doesn't settle or reject within 30 days of receiving all documents, they owe you interest at</text>
    <text x="20" y="184" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">2% above bank rate. File complaint at Bima Bharosa portal if they stall.</text>
  </svg>
);
