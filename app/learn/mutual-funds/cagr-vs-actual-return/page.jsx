...
const SvgCAGRvsXIRR = () => (
  <svg viewBox="0 0 720 292" role="img" aria-label="CAGR versus XIRR comparison showing that a fund with 18 percent CAGR can give only 11 percent XIRR to a SIP investor depending on when each installment was invested and how the market moved" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    <text x="540" y="184" textAnchor="middle" fontFamily="system-ui" fontSize="11" fill="var(--text-muted)">time in market — avg is less than 5yr.</text>
        <text x="20" y="220" fontSize="9" fontFamily="system-ui" fontWeight="700" fill="var(--text)">Why the gap? Fund CAGR measures point-to-point performance on a lump sum. Your SIP had later installments with less time</text>
    <text x="20" y="234" fontSize="9" fontFamily="system-ui" fontWeight="700" fill="var(--text)">to grow.</text>
        <text x="20" y="240" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">SIP installment in Month 1: 60 months to grow. SIP installment in Month 48: only 12 months to grow. Most of your invested</text>
    <text x="20" y="254" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">corpus has much less than 5 years in market.</text>
        <text x="20" y="258" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Correct metric for SIP returns: XIRR (Extended Internal Rate of Return). This accounts for the timing of each cash flow.</text>
    <text x="20" y="272" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Always demand XIRR from your platform — not CAGR.</text>
  </svg>
);

const SvgSequenceOfReturns = () => (
  <svg viewBox="0 0 720 296" role="img" aria-label="Sequence of returns risk showing two funds with identical 10 percent CAGR but different sequences producing very different actual wealth outcomes for SIP investors" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    <text x="360" y="246" textAnchor="middle" fontFamily="system-ui" fontSize="12" fontWeight="700" fill="#fff">Identical CAGR. ₹1.1L difference in actual SIP corpus.</text>
        <text x="20" y="262" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Good early returns allow more units to accumulate at higher NAV before later dips. SIP investors actually benefit from</text>
    <text x="20" y="276" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">early market weakness — they accumulate more units cheaply.</text>
  </svg>
);

const SvgCherryPickedWindows = () => (
  <svg viewBox="0 0 720 266" role="img" aria-label="How mutual fund companies cherry-pick performance windows showing how a fund can show 25 percent 3-year return or 8 percent 5-year return for the same fund depending on start date" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[
      ...
      <g key={window}>
        ...
        <text x="20" y="215" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Always look at 10-year and 15-year CAGR alongside 3-year. Also check rolling returns (average of all 3-year windows in</text>
    <text x="20" y="229" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">the past decade) — a more honest picture of consistent performance.</text>
  </svg>
);

const SvgXIRRCalculation = () => (
  <svg viewBox="0 0 720 354" role="img" aria-label="How to calculate XIRR for your mutual fund SIP showing the three inputs needed and where to find them in your Zerodha or Groww account" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    {[
      ...
      <g key={step}>
        ...
        <text x="20" y="175" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">Most modern platforms (Zerodha Coin, Kuvera, Groww) show XIRR directly in your portfolio. Look for "returns" in your</text>
    <text x="20" y="189" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">dashboard — if it shows "absolute" or "CAGR" without clarifying SIP timing, ask for XIRR explicitly.</text>
  </svg>
);

const SvgRollingReturns = () => (
  <svg viewBox="0 0 720 229" role="img" aria-label="Rolling 3 year returns for Nifty 50 index showing that the average of all 3 year periods since 2005 is around 11 percent even though some periods gave negative returns" style={{ width: "100%", maxWidth: 760, margin: "24px 0" }}>
    ...
    <text x="660" y="96" fontFamily="system-ui" fontSize="10" fill={COLOR} fontWeight="700">avg ~11%</text>
        <text x="20" y="195" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">One 3-year window showed -8% (2006-09 financial crisis). Eight of nine windows showed positive returns. Long-term average</text>
    <text x="20" y="209" fontSize="9" fontFamily="system-ui" fill="var(--text-muted)">is ~11% CAGR for Nifty 50. Cherry-picking any single window tells a different story.</text>
  </svg>
);
