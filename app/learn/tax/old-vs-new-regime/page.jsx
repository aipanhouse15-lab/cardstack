...
function Verdict({ children }) {
  return (
    <div style={{
      ...
      padding: "26px 28px", margin: "24px 0", borderRadius: "6px",
    }}>
...
function MathBox({ children, title = "THE MATH" }) {
  return (
    <div style={{
      ...
      padding: "26px 28px", margin: "20px 0", borderRadius: "6px", fontFamily: "system-ui, -apple-system, sans-serif", fontSize: "14.5px",
    }}>
...
function Warn({ children }) {
  return (
    <div style={{
      ...
      padding: "24px 26px", margin: "20px 0", borderRadius: "6px",
    }}>
