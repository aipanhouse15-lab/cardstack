...
export const MONTHLY_UPDATES = [
  ...
  },
  {
    ...
    entries: [
      ...
      { type: "alert", icon: "📉", card: "HDFC Swiggy", text: "Min ₹249 per transaction for 10% cashback (Apr 17). Card closed to new applicants Mar 12 — replaced by BLCK (₹1,499) and ORNGE (lower fee, 5%) variants.", date: "Apr 2026" },
      { type: "alert", icon: "📉", card: "Scapia", text: "Travel rate cut from 5% to 4% (Feb 27). Utility bills and insurance excluded from rewards AND lounge milestone. New intl airport duty-free perk added.", date: "Apr 2026" },
  ...
  },
  {
    ...
    entries: [
      ...
      { type: "alert", icon: "⚠️", card: "Axis Airtel", text: "Benefits being downgraded from April 2026. Lounge access removed. Zomato/Blinkit getting 10% value back, Airtel bills 25% cashback with ₹250 cap.", date: "Mar 2026" },
    ],
  },
